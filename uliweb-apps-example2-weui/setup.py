#coding=utf8
__doc__ = """uliweb-apps-example2-weui"""
...
setup(
    name='uliweb-apps-example2-weui',
    version=grep('__version__'),
    url=grep('__url__'),
    license='BSD',
    author=grep('__author__'),
    author_email=grep('__email__'),
    description='uliweb-apps-example2-weui',
    long_description=desc(),
    package_dir = {'uliweb-apps-example2-weui':'apps'},
    packages = ["uliweb_apps_example2_weui"],
