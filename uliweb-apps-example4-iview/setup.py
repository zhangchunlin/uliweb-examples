#coding=utf8
__doc__ = """uliweb-apps-example4-iview"""
...
setup(
    name='uliweb-apps-example4-iview',
    version=grep('__version__'),
    url=grep('__url__'),
    license='BSD',
    author=grep('__author__'),
    author_email=grep('__email__'),
    description='uliweb-apps-example4-iview',
    long_description=desc(),
    package_dir = {'uliweb-apps-example4-iview':'apps'},
    packages = ["uliweb_apps_example4_iview"],
