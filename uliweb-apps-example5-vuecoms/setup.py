#coding=utf8
__doc__ = """uliweb-apps-example5-vuecoms"""
...
setup(
    name='uliweb-apps-example5-vuecoms',
    version=grep('__version__'),
    url=grep('__url__'),
    license='BSD',
    author=grep('__author__'),
    author_email=grep('__email__'),
    description='uliweb-apps-example5-vuecoms',
    long_description=desc(),
    package_dir = {'uliweb-apps-example5-vuecoms':'apps'},
    packages = ["uliweb_apps_example5_vuecoms"],
